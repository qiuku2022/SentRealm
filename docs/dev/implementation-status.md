...
**M1 / M2 / M3 已完成。** 桌面壳 **`1.0.0`**。M3 于 2026-09-18 以作者工作环境多次 NSIS 验证关闭。正式发版仍待：严格干净机冒烟、代码签名、公开发布。用户手册安装/分发表述已与 NSIS 对齐。ADR-009 物理拆包仍延后。
...
下一优先：干净机冒烟、代码签名、公开发布。桌面壳版本已为 `1.0.0`。
