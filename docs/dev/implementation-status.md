...
| 干净机冒烟 | 未做（清单见 [packaging.md](./packaging.md)） |
| 代码签名 / 正式公开发布 | 未做 |
| 用户手册安装步骤 | 未改（仍指向团队/开发构建） |
...
| 项 | 去向 |
|----|------|
| 干净机冒烟、签名、公开发布 | 路线图 M3 阻塞 1.0 |
| 用户手册安装节 | 发版时改写 [docs/user/](../user/README.md) |
...
8. **安装包**：脚本与 sidecar 资源路径在仓库内；本核对日未在干净机重打安装包验收
